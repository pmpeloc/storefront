              ...
              <ul className="space-y-0.5">
                <li>
                  <button
                    ...
                    className="w-full text-left px-3 py-2.5 rounded-[10px] text-[12.5px] font-medium transition-all"
                    style={{
                      background: !selectedCategory ? 'var(--beige)' : 'transparent',
                      color: !selectedCategory ? 'var(--marron)' : 'var(--tx-soft)',
                    }}
                  >
                    Todos
                  </button>
                ...
                {categories.map((cat) => (
                  <li key={cat}>
                    <button
                      ...
                      className="w-full text-left px-3 py-2.5 rounded-[10px] text-[12.5px] font-medium transition-all"
                      style={{
                        background: selectedCategory === cat ? 'var(--beige)' : 'transparent',
                        color: selectedCategory === cat ? 'var(--marron)' : 'var(--tx-soft)',
                      }}
                    >
                      {cat}
                    </button>
