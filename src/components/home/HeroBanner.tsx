  ...
  return (
    <section className="pt-8 pb-6 px-4 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="mt-4 text-[13px] max-w-sm mx-auto leading-relaxed" style={{ color: 'var(--tx-soft)' }}>
      ...
      <div
        className="mt-8 rounded-[18px] overflow-hidden max-w-4xl mx-auto relative"
        style={{
      ...
      {/* Barra de beneficios */}
      <div
        className="flex items-center justify-around gap-4 py-5 mt-8 max-w-4xl mx-auto border-t border-b"
      ...
      >
        {[
          ...
          <div key={b.label} className="text-center flex-1">
            <div
              className="w-10 h-10 rounded-full border flex items-center justify-center mx-auto mb-2 text-xs"
